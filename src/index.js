...
function validateConfig() {
  ...
  if (!USER_AGENT) {
    console.warn('USER_AGENT has not been set. Please add contact information.')
  }

  if (!HEALTHCHECKS_IO_TOKEN) {
    console.info('HEALTHCHECKS_IO_TOKEN has not been set. The script execution will not be monitored.')
  }
}
